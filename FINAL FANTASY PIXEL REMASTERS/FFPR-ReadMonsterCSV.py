...
class Monster:
    ...
    def __init__(self,name,lv,hp,mp,exp,gil,strength,vitality,agility,intelligence,spirit,magic,attack,defense,accuracy,evasion,magic_evasion,critical,luck,weight,IsBoss,species,resistance_attribute,resistance_condition,attackNum,attackBonus,dropRate,drops,scriptID):
        self.name = name
        self.lvl = lv
        self.hp = hp
        self.mp = mp
...
for monster in monsterData:
    ...
    monsters.append(Monster(
        ...
        monster['weight'],monster['boss'],monster["species"],monster["resistance_attribute"],monster["resistance_condition"],monster["attack_count"],monster["attack_plus"],monster["drop_rate"],drops,monster["script_id"]))
