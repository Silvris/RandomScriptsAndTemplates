...
class Monster:
    ...
    def __init__(self,name,lv,hp,mp,exp,gil,strength,vitality,agility,intelligence,spirit,magic,attack,defense,abilityDefense,accuracy,evasion,magic_evasion,critical,luck,weight,IsBoss,species,resistance_attribute,resistance_condition,attackNum,attackBonus,dropRate,drops,steals,scriptID):
        self.name = name
        self.lvl = lv
        self.hp = hp
        self.mp = mp
...
outdata = open("FF4-Monsters.txt",'w')
...
for monster in monsterData:
    ...
    monsters.append(Monster(
        ...
        monster['attack'],monster['defense'],monster['ability_defense'],monster['accuracy_rate'],monster['evasion_rate'],monster['magic_evasion_rate'],monster['critical_rate'],monster['luck'],
